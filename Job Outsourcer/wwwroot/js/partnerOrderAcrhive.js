...
$(document).ready(function () {
    ...
    if (url.includes("refundiran")) {
        ...
        else if (url.includes("objavljen")) {
            loadList("objavljen");
        }
        else {
            loadList("preuzet");
...
function loadList(param) {
    dataTable = $('#DT_load').DataTable({
        "ajax": {
            "url": "/api/orderArchive?status=" + param,
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            ...
            { "data": "orderHeader.orderTotal", "width": "20%" },
            {
                ...
                "render": function (data) {
                    return ` <div class="text-center">
                                <a href="/Partner/Jobs_Archive/OrderDetails?id=${data}" class="btn btn-success text-white" style="cussor:pointer; width:100px;">
